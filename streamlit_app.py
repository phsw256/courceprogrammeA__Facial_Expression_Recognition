...
st.write("kl's coruce programme.\nIf u use your phone or browser not big enough, click the \'>\' above to choose what u want to do with this programme.\nUnless locally installed, you can't train the models.")
